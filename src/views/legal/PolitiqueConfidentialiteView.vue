<template>
    <div class="legalContainer">
        <div class="legalContent">
            ...
            <p>Dans le cadre de son activité, la société Vinotrip, dont le siège social est situé au 9 rue Lamolinerie,
                33200
                Bordeaux,
                est amenée à collecter et à traiter des informations dont certaines sont qualifiées de « données
                personnelles
                ». Vinotrip attache une grande importance au respect de la vie privée, et n'utilise que des donnes de
                manière
            ...
            <p>Ces données sont celles que vous nous transmettez directement, via un formulaire de contact ou bien par
                contact
                direct par email. Sont obligatoires dans le formulaire de contact le champs « prénom et nom », «
                entreprise
                ou
            ...
            <p>Lors de vos visites, une fois votre consentement donné, nous pouvons recueillir des informations de type
                «
                web
                analytics » relatives à votre navigation, la durée de votre consultation, votre adresse IP, votre type
                et
                version de
            ...
            <p>Les données que vous nous transmettez directement sont utilisées dans le but de vous re-contacter et/ou
                dans
                le
                cadre de la demande que vous nous faites. Les données « web analytics » sont collectées de forme anonyme
                (en
                enregistrant des adresses IP anonymes) par <b><i>Matomo</i></b>, et nous permettent de mesurer
                ...
                données
                sont utilisées par Vinotrip, responsable du traitement des données, et ne seront jamais cédées à un
                tiers ni
            ...
            <b><i>
                    ...
                    <p>Matomo : Permet de garder en mémoire le fait que vous acceptez les cookies afin de ne plus vous
                        importuner
                        lors de
            ...
            <p>Vos droits concernant les données personnelles
                Vous avez le droit de consultation, demande de modification ou d'effacement sur l'ensemble de vos
                données
